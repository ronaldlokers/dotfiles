...
| `dot_local/bin/` | own scripts: `repos-sync`, `devcontainer-init`, `dotfiles-update-check`, `proton-ssh-load`, `hypr-center-master` (SUPER + SHIFT + T, lays the active workspace out 25/50/25), and `devpod` (wrapper for the binary in `~/.local/libexec`) |
